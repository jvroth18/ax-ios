...
| `single-morse-sos` | "Use the flashlight to signal SOS in Morse code" | signal_morse_code · signal_morse_code.text |
| `single-morse-implicit-flashlight` | "Turn Meet at 5 into Morse code" | signal_morse_code · signal_morse_code.text |
...
| `negative-explain-error-message` | "Explain this error message in plain English" | no tool call |
| `negative-how-phone-works` | "How does a phone work?" | no tool call |
| `negative-explain-morse` | "Explain how Morse code works" | no tool call |
...
| `workflow-x-then-y-then-z` | "Turn on the flashlight, then pause the music, then set a timer for 2 minutes" | repeat_steps · repeat_steps.steps, repeat_steps.times |
